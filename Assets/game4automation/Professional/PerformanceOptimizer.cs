...
namespace game4automation
{
    ...
    public class PerformanceOptimizer : MonoBehaviour
    {
        ...
        [ReadOnly] public static List<GameObject> OptimizedMeshes = new List<GameObject>(); //! List of all optimized meshes
        ...
        [HideInInspector] public static List<MeshRenderer> DeactivatedRenderers = new List<MeshRenderer>();
